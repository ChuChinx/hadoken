<?php  
    ...
    $idproveedor = htmlspecialchars($_POST['idproveedor'], ENT_QUOTES, 'UTF-8');//$_POST['categoria'] lo q llevamos al console ajax 1ero izq
    ...
    $consulta = $MI->Registrar_Ingreso($idproveedor, $idusuario, $tipo, $serie, $ncomprobante, $total, $impuesto, $porcentaje);//de ahi al modelo
    echo $consulta;
