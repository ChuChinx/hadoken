<?php
    ...
    if(!isset($_SESSION['S_IDUSUARIO'])){ //si sesion no existe redireccionar al ologin
...
<head>
    ...
    <title>Admincast bootstrap 4 &amp; angular 5 admin | Dashboard</title>
    ...
    <style>
        table.dataTable thead{
            background: linear-gradient(to right, #253544, #3498db);
            color: #fff;
        }
    </style>
...
<body class="fixed-navbar">
    <div class="page-wrapper">
                ...
                <ul class="nav navbar-toolbar">
                    ...
                    <li class="dropdown dropdown-user">
                        ...
                        <ul class="dropdown-menu dropdown-menu-right">
                            ...
                            <a class="dropdown-item" href="../controlador/usuario/controlador_cerrar_session.php"><i class="fa fa-power-off"></i>Logout</a>
                        </ul>
                    </li>
                </ul>
        ...
        <nav class="page-sidebar" id="sidebar">
            <div id="sidebar-collapse">
                <div class="admin-block d-flex">
                    ...
                    <div class="admin-info">
                        <div class="font-strong">
                            <label for="" id="usu_sidebar"></label><!-- id para llamar los datos del usuario-->
                        </div>
                        <small id="rol_sidebar"></small><!-- id para llamar los datos del usuario-->
                    </div>
                </div>
                <ul class="side-menu metismenu">
                    ...
                    <li class="heading">M&Oacute;DULOS</li>
                    <li>
                    ...
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'usuario/vista_mantenimiento_usuario.php')"><i class="sidebar-item-icon fa fa-user-circle"></i>
                            <span class="nav-label">Usuario</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'cliente/vista_mantenimiento_cliente.php')"><i class="sidebar-item-icon fa fa-users"></i>
                            <span class="nav-label">Cliente</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'proveedor/vista_mantenimiento_proveedor.php')"><i class="sidebar-item-icon fa fa-users"></i>
                            <span class="nav-label">Proveedor</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'categoria/vista_mantenimiento_categoria.php')"><i class="sidebar-item-icon fa fa-folder-o"></i>
                    ...
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'insumo/vista_mantenimiento_insumo.php')"><i class="sidebar-item-icon fa fa-dropbox"></i>
                            <span class="nav-label">Insumos</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'producto/vista_mantenimiento_producto.php')"><i class="sidebar-item-icon fa fa-cube"></i>
                            <span class="nav-label">Productos</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'combo/vista_mantenimiento_combo.php')"><i class="sidebar-item-icon fa fa-cubes"></i>
                            <span class="nav-label">Combos</span><i class="fa fa-angle-left arrow"></i></a>
                    </li>
                    <li>
                        <a href="javascript:cargar_contenido('contenido_principal', 'ingreso/vista_mantenimiento_ingreso.php')"><i class="sidebar-item-icon fa fa-shopping-cart"></i>
        ...
        <div class="content-wrapper">
            <input type="text" value="<?php echo $_SESSION['S_IDUSUARIO']; ?>" id="txt_codigo_principal" hidden> <!-- value para escribir el id del usuario-->
            <!-- START PAGE CONTENT-->
            <div class="page-content fade-in-up">
                <div class="" id="contenido_principal"> <!--id para cambiar el contenido y dejar estatico la barra lateral con la funcion cargar_contenido-->
                    <div class="row">
            ...
            <footer class="page-footer">
                <div class="font-13">2021 © <b>Had</b> - Derechos Reservados.</div>
                <a class="px-4" href="https://www.hadoken.com.pe/" target="_blank">Hadoken Sushi Bar</a>
